...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{assets/13_tests_E2E/code_github_actions_playwright1.png}\par\smallskip
  \includegraphics[width=0.4\textwidth]{assets/13_tests_E2E/code_github_actions_playwright2.png}\par\smallskip
  \includegraphics[width=0.6\textwidth]{assets/13_tests_E2E/code_github_actions_playwright3.png}
  \caption{CI E2E}
  \label{fig:e2e-ci}
\end{figure}
